...
| SSL-v2 | Earlier evidence-pack text still described the old fold-1 partial scope. | Updated to complete-real folds 1-5, horizons 10/50, seeds 0-2, with scoped predictive and calibration support. |
...
- SSL-v2 predictive and calibration improvement is scoped to the exact stored
  folds 1-5, horizons 10/50, seeds 0-2, lookback-50 slice. Results are mixed by
  seed and horizon, and broad SSL improvement remains unsupported.
