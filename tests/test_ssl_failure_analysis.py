...
These tests confirm that the analysis consumes only stored summary
artefacts, does not require raw prediction files, blocks broad SSL
improvement claims, labels the narrow fold-1/horizon-50 validation-selected finding
