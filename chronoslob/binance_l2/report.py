...
def render_binance_report_markdown(
    *,
    ...
    if fixture_data:
        ...
        scope = [
            "The extension covers crypto-market data engineering support:",
...
def _storage_section(summary: Mapping[str, Any]) -> list[str]:
    rows = [
        ...
        ("summary_artefacts", "small summaries, CSVs and JSON only"),
        ("raw_capture_policy", "large raw captures are git-ignored by default"),
    ]
    return [
        "## Storage Footprint",
        "",
        "Only compact summaries are stored. Large raw captures are written to a",
