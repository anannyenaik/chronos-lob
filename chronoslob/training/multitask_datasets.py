...
This module combines field-wise token windows
(:mod:`chronoslob.training.token_datasets`) with an external supervised label
...
filtering or execution simulation.
"""
