...
The synthetic smoke runner constructs deterministic records and exercises the
analysis layer end to end. Its outputs describe implementation behaviour only.
"""
...
SYNTHETIC_ANALYSIS_WARNING = (
    "Synthetic analysis smoke test; records do not represent market observations, "
    "tradability or live performance."
)
