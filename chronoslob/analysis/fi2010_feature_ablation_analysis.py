...
def analyse_fi2010_feature_ablations(
    *,
    ...
    """Analyse feature-ablation stability from stored summary CSV files."""
    ...
    return {
        ...
        "claims": {
            ...
            "execution_aware_ablation_diagnostics": {
                ...
                "reason": (
                    "ablation prediction files are available"
                    if raw_predictions_available
                    else (
                        "Execution-aware ablation diagnostics require stored "
...
def _render_markdown(
    *,
    ...
    lines = [
        ...
        "",
        "This report extends the feature-ablation results with a "
        "focused feature-stability analysis.",
        "",
        SNAPSHOT_PROXY_SCOPE_NOTE,
        "",
        ...
        *_markdown_table(
            ...
            [
                ...
                ("raw predictions available", "yes" if raw_predictions_available else "no"),
            ],
        ),
        "",
