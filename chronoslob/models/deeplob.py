...
class DeepLOBConfig:
    ...
    The defaults are deliberately small to keep CPU checks fast. This is a
    DeepLOB-style baseline rather than an exact reproduction of DeepLOB.
    """
...
def create_deeplob_model(config: DeepLOBConfig) -> DeepLOBModel:
    ...
    smoke testing. A future implementation can match the paper's exact channel
