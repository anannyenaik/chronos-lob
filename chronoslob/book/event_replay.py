...
def snapshots_from_event_log_records(
    ...
    *,
    ...
    Generic :class:`BookEvent` reconstruction is not implemented. Binance-style
    replay should first reconstruct snapshots, then persist them as event-log
    records.
    """
    ...
    if not snapshots:
        raise ValueError(
            ...
            "BookEvent reconstruction is not implemented"
        )
    return snapshots
